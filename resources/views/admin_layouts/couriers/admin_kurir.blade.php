    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary text-center">List Kurir</h6>
            </div>
            <div class="card-body">
                <div class="card-body">
                    <!-- Tombol Tambah -->
                    <a href="/admin/kurir/buat" class="btn btn-success btn-icon-split">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            @foreach ($data_kurir as $no => $kurir)
                            <tr>
                                <td>{{ $no+1 }}</td>
                                <td>{{ $kurir->courier }}</td>
