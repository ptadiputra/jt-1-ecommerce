                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form method="POST" class="user" action ="{{ route('register') }}" aria-label="{{ __('Register') }}" enctype="multipart/form-data">
                            ...
                            @csrf
                                ...
                                {{-- <div class="col-sm-6 mb-3 mb-sm-0">
                                    <div class="form-group row ">
                                        ...
                                        <input type="file" class="form-control" placeholder="Enter your promocode" name="foto_pengguna[]" required>
                                    </div>
                                </div> --}}
